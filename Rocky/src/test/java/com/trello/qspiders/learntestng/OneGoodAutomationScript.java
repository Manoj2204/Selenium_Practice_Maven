...
public class OneGoodAutomationScript {
	...
	public void actiTimeLoginLogout(String username, String password) throws Throwable {
		...
		Thread.sleep(2000);
		//softAssert.assertTrue(wait.until(ExpectedConditions.titleIs("actiTIME - Login")),
			//	"The Login page title is not found correct.");
		// Assert.assertTrue(wait.until(ExpectedConditions.titleIs("actiTIME -
		// Login")),"The Login page title is not found correct.");
		softAssert.assertEquals(driver.getTitle(), "actiTIME - login");
		...
		softAssert.assertTrue(
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("logoutLink"))).isDisplayed(),
				"The Logout Option Is not visible.");
		Reporter.log("Home Page is displayed");
		// wait.until(ExpectedConditions.elementToBeClickable(By.id("logoutLink")));
		WebElement logoutLink = driver.findElement(By.id("logoutLink"));
		wait.until(ExpectedConditions
				.invisibilityOfElementLocated(By.xpath("//div[@id='preInsertedTransformedMoireId']")));
		logoutLink.click();
